...
public class EstudianteRepository {
    ...
    public Estudiante save(Estudiante estudiante) { // Metodo para guardar un estudiante en el repositorio
    ...
    public List<Estudiante> findAll() { // Metodo para obtener todos los estudiantes
        return new ArrayList<>(estudiantes.values()); // Retorna una lista de todos los estudiantes en el mapa
    }
    
    public void deleteById(Long id) { // Metodo para eliminar un estudiante por su ID
        estudiantes.remove(id); // Elimina el estudiante del mapa
    }
    public boolean deleteByIdV2(Long id){
    ...
    public Estudiante verificarExistencia(Long id){
        if(estudiantes.containsKey(id)){
    ...
    // Metodo para inicializar algunos datos de ejemplo
    public void init() {
        Estudiante estudiante1 = Estudiante.builder() // Crea un estudiante usando el patrón builder
